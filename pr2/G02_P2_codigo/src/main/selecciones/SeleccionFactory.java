...
public class SeleccionFactory {
    ...
    public static Seleccion getAlgSeleccion(int n, double[] fitness, int tamPoblacion, boolean min, double mejor) {
        switch (n) {
            case 0:
                return new Ruleta(fitness, tamPoblacion, min, mejor);
            case 1:
                return new TorneoDeterministico(fitness, tamPoblacion, min);
            case 2:
                return new TorneoProbabilistico(fitness, tamPoblacion, min, PROBABILITY_FACTOR);
            case 3:
